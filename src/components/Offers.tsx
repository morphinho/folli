...
export default function Offers() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-white to-[#F5F5F5]">
          ...
          {offers.map((offer, index) => (
            <div
              ...
              className={`relative bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 ${
                offer.highlight
                  ? 'transform md:-translate-y-4 border-4 border-[#FFD700] shadow-2xl'
                  : 'border border-gray-200 hover:shadow-2xl'
              }`}
            >
              {offer.badge && (
                <div className="bg-gradient-to-r from-[#FFD700] to-[#D4AF37] text-[#3E2723] text-center py-3 px-4 font-bold text-lg flex items-center justify-center gap-2">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  className="block w-full bg-gradient-to-r from-[#3E2723] to-[#5D4037] hover:from-[#2E1B17] hover:to-[#4E342E] text-white font-bold text-lg py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 mb-4 text-center"
                >
                  COMPRAR AGORA!
                </a>
